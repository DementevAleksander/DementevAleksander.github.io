...
function timer(id, deadline) {
    ...
    const dateNew = Date.parse(new Date()) + 899999999
    function getTimeRemaining(endtime) {
        ...
        const t = dateNew - Date.parse(new Date()),
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2021-12-31');
